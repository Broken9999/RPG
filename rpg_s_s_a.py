...
Original file is located at
    https://colab.research.google.com/drive/1NVwqJnZPUCfYgeNaDZgjv8F-CX3MzXYu
"""
    ...
    if accept_quest == "yes":
        ...
        for i in range(3):
            ...
            if result == "yes":
                ...
                shards_collected += 1
                print(f"You have collected {shards_collected} Shard(s) of Light.")
            else:
        ...
        if shards_collected == 3:
            ...
            print(f"\nCongratulations! After collecting all the Shards of Light, the NPC reveals your new subclass: {new_subclass}.")
            player_subclass = new_subclass
        else:
            print("\nYou were unable to collect all the Shards of Light. The quest remains incomplete.")
