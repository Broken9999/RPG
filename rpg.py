...
Original file is located at
    https://colab.research.google.com/drive/1H0ZAkhh_7yOav2RkNfhgVrVmF_IkLV6O
"""
...
elements = ["Fire", "Ice", "Lightning", "Earth", "Water", "Air", "Darkness", "Light", "Poison"]
...
def job_change_quest():
    ...
    if random.choice([True, False]):
        ...
        print("Complete this quest to unlock a new subclass or hidden class!")

        new_subclass = random.choice(subclasses.get(player_class, []))
        print(f"Congratulations! You have unlocked the {new_subclass} subclass.")
